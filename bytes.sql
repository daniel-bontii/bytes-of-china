...
--Validate the existence of primary key in restuarant
SELECT
    constraint_name,
    table_name,
    column_name
...
--Validate the existence of primary key in address
SELECT
    constraint_name,
    table_name,
    column_name
...
--Validate the existence of foreign key in address
SELECT
    constraint_name,
    table_name,
    column_name
...
--Validate the existence of foreign key in review
SELECT
    constraint_name,
    table_name,
    column_name
...
--Validate the existence of primary and foreign keys in categories_dishes
SELECT
    constraint_name,
    table_name,
    column_name
